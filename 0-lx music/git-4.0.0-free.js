const UPDATE_URL = "https://source.shiqianjiang.cn/script/mf/git.js?key=.js";
const VERSION = "4.0.0";
...
function getUserVariables() {
  let { owner, repo, token } = env && env.getUserVariables();
  return {
...
async function getMusicSheetInfo(sheet, page = 1) {
  let list = (await axios_1.default.get(getGitcodeUrl())).data;
